(function () {
  ...
  var TCGCSV_BASE = 'https://tcgcsv.com/tcgplayer';
  ...
  // tcgcsv.com, a public mirror of TCGplayer's catalog/pricing API.
  ...
  function buildCard(entry, product, priceEntry) {
    ...
    return {
      ...
      rarity: (product && extendedValue(product, /rarity/i)) || 'Unknown',
      condition: 'Near Mint',
  ...
  function showErrorState() {
    els.binderGrid.style.display = 'none';
    els.emptyState.style.display = 'block';
    els.emptyState.textContent = 'Could not load live pricing right now — TCGplayer/tcgcsv.com may be temporarily unavailable. Try refreshing.';
  }
