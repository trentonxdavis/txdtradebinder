(function () {
  ...
  // --- Data loading ------------------------------------------------------
  // cards.json is regenerated by a scheduled GitHub Action (see
  // scripts/fetch_prices.py) that merges collection.json against live
  // tcgcsv.com pricing server-side, where CORS doesn't apply. The page
  // itself only ever reads this same-origin file.
  ...
  function showLoadingState() {
    ...
    els.emptyState.textContent = 'Loading the binder…';
  }

  function showErrorState() {
    els.binderGrid.style.display = 'none';
    els.emptyState.style.display = 'block';
    els.emptyState.textContent = 'Could not load the binder right now. Try refreshing.';
  }
